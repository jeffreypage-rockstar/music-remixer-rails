...
WaveSurfer.create = function(a) {
    ...
    createMasterGain: function() {
        if (_masterGain == null) {
            ...
            _masterLimiter.threshold.value = -0.1; // this is the pitfall, leave some headroom
    ...
    createVolumeNode: function() {
        ...
        this.ac.createGain ? this.gainNode = this.ac.createGain() : this.gainNode = this.ac.createGainNode(), this.gainNode.connect(_masterLimiter)
    },
    setVolume: function(a) {
